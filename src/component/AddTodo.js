...
class AddTodo extends Component {
  ...
  // The handle function updates the react state with the new input value provided from the user.
  // "event" is the defined action a user takes. In this case, the event is triggered when the user types something
  // into the text field or selects it from the calendar.
    ...
    return (
      ...
      <div>
        ...
        <DesktopDatePicker
            ...
            onChange={this.handleDueDateSelection}
